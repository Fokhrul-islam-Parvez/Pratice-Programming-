...
public class Playfair {
    public static void main(String[] args) {
		...
		String encryptionMessage = tc.getEncryptionText("DAFFODIL INTERNATIONAL UNIVERSITY", "elephant", 'i');
        System.out.println("Encryption Mesaage is : "+encryptionMessage);
        
      String decryptionMessage = tc.getDecryptionMesage("MDIVOVBMPGTBPODEBGVFEPODFXPORKCW", "elephant", 'i');
